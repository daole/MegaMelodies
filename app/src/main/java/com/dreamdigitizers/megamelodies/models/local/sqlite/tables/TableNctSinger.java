...
public class TableNctSinger extends TableBase {
    ...
    public static final String COLUMN_NAME__IMG = "img";
    ...
    public static final String COLUMN_NAME_ALIAS__IMG = TableNctSinger.TABLE_NAME + "_" + TableNctSinger.COLUMN_NAME__IMG;
    ...
    private static final String STATEMENT_CREATE = "CREATE TABLE `" + TableNctSinger.TABLE_NAME + "` ("
            ...
            + "`" + TableNctSinger.COLUMN_NAME__IMG + "` TEXT NOT NULL,"
    ...
    public static List<String> getColumns(boolean pIsIncludeTableName, boolean pIsIncludeIdColumn) {
        ...
        columns.add(tableName + TableNctSinger.COLUMN_NAME__IMG + (pIsIncludeTableName ? (" as "  + TableNctSinger.COLUMN_NAME_ALIAS__IMG) : ""));
