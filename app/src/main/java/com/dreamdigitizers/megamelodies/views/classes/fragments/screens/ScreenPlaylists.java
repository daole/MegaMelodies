...
public class ScreenPlaylists extends ScreenMediaItems<IPresenterPlaylists> implements IViewPlaylists, AdapterPlaylist.IOnItemClickListener {
    ...
    public void onItemClicked(MediaBrowserCompat.MediaItem pMediaItem) {
        if (this.mListener != null) {
            this.mListener.onPlaylistSelected(pMediaItem);
        }
    }
    ...
    public void setOnPlaylistSelectedListener(IOnPlaylistSelected pListener) {
        this.mListener = pListener;
    }

    public interface IOnPlaylistSelected {
        void onPlaylistSelected(MediaBrowserCompat.MediaItem pMediaItem);
    }
}
